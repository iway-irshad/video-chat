...
const RejectedRequestCard = ({ notification, otherPerson, message, onClick }) => {
  return (
    <div 
      className="card bg-base-200 shadow-sm opacity-75 hover:opacity-100 hover:shadow-md transition-all cursor-pointer"
      onClick={onClick}
    >
